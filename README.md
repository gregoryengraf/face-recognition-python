...
[![Deploy to DigitalOcean](https://www.deploytodo.com/do-btn-blue.svg)](https://cloud.digitalocean.com/apps/new?repo=[https://github.com/digitalocean/sample-python](https://github.com/gregoryengraf/face-recognition-python/)/tree/main)
